...
describe('routing tests', function() {
  ...
  it('the page selector switches pages', async function() {
    ...
    await testNavigation(page, 'admin-view', 'Admin View');
    await testNavigation(page, 'teacher-view', 'Teacher View');
    await testNavigation(page, 'driver-view', 'Driver View');
  });
  ...
  it('the page selector switches pages in a different way', async function() {
    ...
    await testNavigationInADifferentWay(page, 'admin-view', 'Admin View');
    await testNavigationInADifferentWay(page, 'teacher-view', 'Teacher View');
    await testNavigationInADifferentWay(page, 'driver-view', 'Drive View');
  });
});
