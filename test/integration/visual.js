...
describe('👀 page screenshots are correct', function() {
  ...
  describe('wide screen', function() {
    ...
    it('/admin-view', async function() {
      return takeAndCompareScreenshot(page, 'admin-view', 'wide');
    });
    it('/teacher-view', async function() {
      return takeAndCompareScreenshot(page, 'teacher-view', 'wide');
    });
  ...
  describe('narrow screen', function() {
    ...
    it('/teacher-view', async function() {
      return takeAndCompareScreenshot(page, 'teacher-view', 'narrow');
    });
    it('/view2', async function() {
